...
This is especially visible in Figure \ref{fig:x-t-graph_100ms_zoom_velocity} (c) in the derivative of the smoothed data at both large steps, that is, freom \SI{2290}{ms} to \SI{2315}{ms} and \SI{2490}{ms} to \SI{2515}{ms}.  
...
This further corroborates the deceleration due to drag increase rather than a decrease of magnetic field strength as the field gradient is left. 
...
After bombardement, this and that happenes, causing a broadening of one domain over the other.
...
\begin{figure}[tbh]
    ...
    (b) $x$ over $t$ graph of a transport experiment in the linear regime of a single \ac{MP}.
