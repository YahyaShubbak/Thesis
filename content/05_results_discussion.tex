...
Such a graph is presented in Figure \ref{fig:x-t-graph}.

\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Abbildungen/Evaluation/xvst_mean_Dynabeads M-270 (2.00 Hz, 125 ms).pdf}
