...
The red rectangle is shown as a zoom in in Figure \ref{fig:x-t-graph_100ms_zoom} (b) to more clearly present the individual steps and how they are correlated with the alternating pulsed field sequence, depicted on top in (a).
\begin{figure}[tbh]
    \centering
...
In the depicted case of Figure \ref{fig:x-t-graph_100ms_zoom}, the asyymetrie is 
\begin{equation}
...
\begin{figure}[tbh]
    \centering
    \includegraphics[width=0.8\linewidth]{Abbildungen/Evaluation/x_t_COOH_100ms_zoom_field_steps.pdf}
    \caption{
    $x$ over $t$ graph of a transport experiment in the linear regime.
    }
    \label{fig:x-t-graph_100ms_zoom}
\end{figure}
...
\begin{figure}[tbh]
    ...
    \caption{
    $x$ over $t$ graph of a transport experiment in the linear regime.
    Smoothing via moving average with a window of \SI{20}{ms}.
    }
