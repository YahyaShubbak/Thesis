...
Therefore, the acceleration phase is assumed to be instantaneous and the force equilibrium between $F_\mathrm{m,x}$ and $\mathbf{F}_\mathrm{D}(z,t)$ is reached.
...
Far away, that is, several $\si{\micro \m}$, $f_\mathrm{D}=1$, and will not influence the drag, thus a perceived linear velocity is observed. 
...
\begin{figure}[tbh]
    \centering
    \includegraphics[width=0.8\linewidth]{Abbildungen/Evaluation/x_t_COOH_100ms_zoom_field_steps_velocity.pdf}
    \caption{
    ...
    \label{fig:x-t-graph_100ms_zoom_velocity_velocity}
\end{figure}
