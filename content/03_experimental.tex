...
Sputter deposition is most commonly used to achieve monolayer accuracy in thickness, creating the magnetic thin film stack used in this work \cite{Seshan2012}.    
...
When non-inert gases, such as oxygen or nitrogen, are used, the process is then called reactive sputtering, which is typically used to deposit oxides or nitrides.
...
For \ac{DC} diode sputtering, two plates working as the anode and the cathode connected to a power supply are placed in a vacuum.
